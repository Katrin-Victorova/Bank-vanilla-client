...
import { BALANCE_UPDATED } from '@/constrants/event.constants'
import { $R } from '@/core/rquery/rquery.lib'
import { NotificationService } from '@/core/services/notification.service'
import validationService from '@/core/services/validation.service'
import Store from '@/core/store/store'
import * as styles from './actions.module.scss' // * as !!!
import template from './actions.template.html'

export default class Actions extends ChildComponent {
	constructor() {
		super()
	...
	/**
	 * @param {Event} event — объект события при клике на кнопку
	 * @param {'top-up' | 'withdrawal'} type — тип операции: пополнение или снятие
	 */
