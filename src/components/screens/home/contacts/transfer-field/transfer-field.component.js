...
export default class TransferField extends ChildComponent {
	...
	handleTransfer = event => {
		...
		this.cardService.transfer({
			...
			toCardNumber,
			onSuccess: () => {
				inputElement.value('') // если у тебя правда метод value()
				amount = ''
